...
function updateDia() {
    ...
    switch (document.getElementById("dias").value) {
        case "0":
            ...
            document.getElementById("item1").innerHTML = "Ensalada César";
            document.getElementById("item2").innerHTML = "Sopa de tomate";
            document.getElementById("item3").innerHTML = "Pechuga de pollo a la plancha";
            document.getElementById("item4").innerHTML = "Fruta fresca";

            break;
        case "1":
            document.getElementById("seleccion").innerHTML = "Menu del Martes:";
            document.getElementById("item1").innerHTML = "Ensalada de atún";
            document.getElementById("item2").innerHTML = "Sopa de verduras";
            document.getElementById("item3").innerHTML = "Filete de pescado al horno";
            document.getElementById("item4").innerHTML = "Yogur con frutas";
            break;
        case "2":
            document.getElementById("seleccion").innerHTML = "Menu del Miércoles:";
            document.getElementById("item1").innerHTML = "Ensalada de quinoa";
            document.getElementById("item2").innerHTML = "Sopa de lentejas";
            document.getElementById("item3").innerHTML = "Tacos de carne asada";
            document.getElementById("item4").innerHTML = "Helado de vainilla";
            break;
        case "3":
            document.getElementById("seleccion").innerHTML = "Menu del Jueves:";
            document.getElementById("item1").innerHTML = "Ensalada de espinacas";
            document.getElementById("item2").innerHTML = "Sopa de pollo con fideos";
            document.getElementById("item3").innerHTML = "Pizza de pepperoni";
            document.getElementById("item4").innerHTML = "Brownie de chocolate";
            break;
        case "4":
            document.getElementById("seleccion").innerHTML = "Menu del Viernes:";
            document.getElementById("item1").innerHTML = "Ensalada de frutas";
            document.getElementById("item2").innerHTML = "Sopa de mariscos";
            document.getElementById("item3").innerHTML = "Hamburguesa con papas fritas";
            document.getElementById("item4").innerHTML = "Pastel de queso";
            break;
            default:
            document.getElementById("seleccion").innerHTML = "Menu del Lunes:";
            document.getElementById("item1").innerHTML = "Ensalada César";
